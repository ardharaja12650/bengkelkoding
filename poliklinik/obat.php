    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($data['tanggal_kadaluarsa']) ?></td>
...
if (isset($_POST['simpan'])) {
    if (isset($_POST['id'])) {
        ...
        $tambah = mysqli_query($koneksi, "INSERT INTO obat (`nama_obat`,`jenis_obat`,`tanggal_kadaluarsa`,`dosis_obat`) 
                                        VALUES ( 
                                            '" . $_POST['nama_obat'] . "',
                                            '" . $_POST['jenis_obat'] . "',
